...
process vVelocities
    ...
    moveText ("Instantaneous Vertical Velocity:", 0.5, (maxy - (maxy div 6)) + (maxy div 10), font, blue)
    moveText ("Time:", 0.8, (maxy - (maxy div 6)) + (maxy div 10), font, blue)
    loop
        vVelocity := verticalvel1 + (g * timecount)
        delay (20)
        drawfillbox((maxx div 2) - (maxx div 25), (maxy - (maxy div 6)) + (maxy div 20), (maxx div 2) + (maxx div 2), (maxy - (maxy div 6)) + (maxy div 15), white)
        moveText (realstr(vVelocity, (maxx div maxy)), 0.5, (maxy - (maxy div 6)) + (maxy div 20), font, blue)
        moveText (realstr(timecount, (maxx div maxy)), 0.8, (maxy - (maxy div 6)) + (maxy div 20), font, blue)
        exit when
        timecount > totaltime
    end loop
end vVelocities
